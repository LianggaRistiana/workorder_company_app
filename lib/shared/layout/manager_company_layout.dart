...
class ManagerCompanyLayout extends StatefulWidget {
  ...
  @override
  State<ManagerCompanyLayout> createState() => _ManagerCompanyState();
}

class _ManagerCompanyState extends State<ManagerCompanyLayout> {
  int _currentIndex = 0;
  ...
  final List<NavItem> _navItems = const [
    ...
    NavItem('Perintah Kerja', Icons.assignment_rounded, AppRoutes.managerWorkorder),
  ];
