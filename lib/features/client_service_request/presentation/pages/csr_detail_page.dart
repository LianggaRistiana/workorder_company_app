...
import 'package:workorder_company_app/features/client_service_request/presentation/widgets/service_request_detail_content.dart';
...
class CsrDetailPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MultiBlocProvider(
      providers: [
        BlocProvider<InternalCsrDetailCubit>(
          create: (_) => sl<InternalCsrDetailCubit>()..getCsrDetail(csrId),
        ),
        BlocProvider<InternalCsrActionsCubit>(
