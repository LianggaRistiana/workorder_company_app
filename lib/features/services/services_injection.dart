...
Future<void> initServicesFeature() async {
  ...
  sl.registerLazySingleton<GetServiceByIdUsecase>(() => GetServiceByIdUsecase(sl()));
  sl.registerLazySingleton<CreateServiceUsecase>(() => CreateServiceUsecase(sl()));

  sl.registerFactory<ServicesBloc>(
      () => ServicesBloc(getServicesUsecase: sl(), getServiceByIdUsecase: sl(), createServiceUsecase: sl()));
}
