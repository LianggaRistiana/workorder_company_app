...
enum ProviderActionServiceRequestStatus {
  initial,
  loading,
  rejected,
  approved,
...
class ProviderActionServiceRequestState extends Equatable {
  final ProviderActionServiceRequestStatus status;
  final ProviderServiceRequestEntity? request;
  final String? errorMessage;

  const ProviderActionServiceRequestState({
    this.status = ProviderActionServiceRequestStatus.initial,
    this.request,
    this.errorMessage,
  });

  ProviderActionServiceRequestState copyWith({
    ProviderActionServiceRequestStatus? status,
