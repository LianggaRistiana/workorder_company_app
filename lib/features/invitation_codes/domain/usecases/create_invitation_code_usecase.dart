...
class CreateInvitationCodeUsecase {
  ...
  CreateInvitationCodeUsecase(this._repository);

  Future<Either<Failure, InvitationCodeEntity>> call(InvitationCodeDraftEntity draft) async {
    return await _repository.createInvitationCode(draft);
  }
}
